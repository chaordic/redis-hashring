...
var RedisRing = function(endpoints) {
...
RedisRing.prototype._getClient = function(key) {
    var hash = md5(key);
    ...
    while (true) {
        ...
        if (pos === startPos) {
            console.error("[redis-ring] No redis nodes available!");
            return;
        }
    }
};

RedisRing.prototype._call = function(command, args) {
...
commands.forEach(function(command) {
    RedisRing.prototype[command] = function() {
